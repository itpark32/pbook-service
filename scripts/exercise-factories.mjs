...
// До урока о функциях упражнения должны запускаться как обычные программы.
// Эти наборы намеренно не используют function judge и def.
const earlyProfiles = {
  nested: [
    stdin("Пары с суммой", "В первой строке N, во второй N чисел, в третьей target. Посчитайте пары индексов i < j с суммой target.", "n = int(input())\nvalues = list(map(int, input().split()))\ntarget = int(input())\ncount = 0\nfor i in range(n):\n    for j in range(i + 1, n):\n        if values[i] + values[j] == target:\n            count += 1\nprint(count)", [["4\n1 2 3 4\n5\n", "2\n"], ["3\n1 1 1\n2\n", "3\n"], ["1\n7\n7\n", "0\n"]]),
    stdin("Минимум после позиции", "В первой строке N и start, во второй N чисел. Выведите минимальный элемент начиная с позиции start (нумерация с нуля).", "n, start = map(int, input().split())\nvalues = list(map(int, input().split()))\nsmallest = values[start]\nfor i in range(start + 1, n):\n    if values[i] < smallest:\n        smallest = values[i]\nprint(smallest)", [["4 1\n5 2 7 1\n", "1\n"], ["3 0\n4 4 4\n", "4\n"], ["1 0\n-3\n", "-3\n"]]),
    stdin("Тройки с суммой", "В первой строке N, во второй N чисел, в третьей target. Посчитайте тройки индексов i < j < k с суммой target.", "n = int(input())\nvalues = list(map(int, input().split()))\ntarget = int(input())\ncount = 0\nfor i in range(n):\n    for j in range(i + 1, n):\n        for k in range(j + 1, n):\n            if values[i] + values[j] + values[k] == target:\n                count += 1\nprint(count)", [["4\n1 2 3 4\n6\n", "1\n"], ["3\n1 1 1\n3\n", "1\n"], ["2\n2 3\n5\n", "0\n"]])
  ],
  strings: [
    stdin("Количество букв a", "Прочитайте строку и выведите число латинских букв a.", "text = input()\ncount = 0\nfor char in text:\n    if char == 'a':\n        count += 1\nprint(count)", [["abracadabra\n", "5\n"], ["Python\n", "0\n"], ["aaa\n", "3\n"]]),
    stdin("Строка наоборот", "Прочитайте строку и выведите её символы в обратном порядке.", "text = input()\nprint(text[::-1])", [["python\n", "nohtyp\n"], ["a\n", "a\n"], ["\n", "\n"]]),
    stdin("Палиндром", "Выведите YES, если строка читается одинаково слева направо и справа налево, иначе NO.", "text = input()\nif text == text[::-1]:\n    print('YES')\nelse:\n    print('NO')", [["level\n", "YES\n"], ["python\n", "NO\n"], ["\n", "YES\n"]])
  ],
  stringAlgorithms: [
    stdin("Первая одинаковая пара", "Прочитайте строку и выведите индекс первого символа первой пары одинаковых соседей или -1.", "text = input()\nanswer = -1\nfor i in range(len(text) - 1):\n    if text[i] == text[i + 1]:\n        answer = i\n        break\nprint(answer)", [["abcc\n", "2\n"], ["abc\n", "-1\n"], ["aa\n", "0\n"]]),
    stdin("Количество смен", "Прочитайте строку и посчитайте позиции, где символ отличается от предыдущего.", "text = input()\ncount = 0\nfor i in range(1, len(text)):\n    if text[i] != text[i - 1]:\n        count += 1\nprint(count)", [["aabcca\n", "3\n"], ["\n", "0\n"], ["xxx\n", "0\n"]]),
    stdin("Максимальная серия", "Прочитайте строку и выведите длину самой длинной серии одинаковых соседних символов.", "text = input()\nbest = 0\ncurrent = 0\nprevious = None\nfor char in text:\n    if char == previous:\n        current += 1\n    else:\n        previous = char\n        current = 1\n    if current > best:\n        best = current\nprint(best)", [["aaabbc\n", "3\n"], ["\n", "0\n"], ["x\n", "1\n"]])
  ],
  lists: [
    stdin("Сумма положительных", "В первой строке N, во второй N чисел. Выведите сумму положительных элементов.", "n = int(input())\nvalues = list(map(int, input().split()))\ntotal = 0\nfor value in values[:n]:\n    if value > 0:\n        total += value\nprint(total)", [["3\n1 -2 3\n", "4\n"], ["2\n-5 0\n", "0\n"], ["0\n\n", "0\n"]]),
    stdin("Удвоенный список", "В первой строке N, во второй N чисел. Выведите элементы, умноженные на 2, через пробел.", "n = int(input())\nvalues = list(map(int, input().split()))\nresult = []\nfor value in values[:n]:\n    result.append(str(value * 2))\nprint(' '.join(result))", [["3\n1 -2 0\n", "2 -4 0\n"], ["1\n7\n", "14\n"], ["0\n\n", "\n"]]),
    stdin("Индексы чётных", "В первой строке N, во второй N чисел. Выведите индексы чётных элементов через пробел.", "n = int(input())\nvalues = list(map(int, input().split()))\nresult = []\nfor i in range(n):\n    if values[i] % 2 == 0:\n        result.append(str(i))\nprint(' '.join(result))", [["3\n3 4 6\n", "1 2\n"], ["2\n1 3\n", "\n"], ["0\n\n", "\n"]])
  ],
  listSearch: [
    stdin("Первое вхождение", "В первой строке N, во второй N чисел, в третьей target. Выведите индекс первого target или -1.", "n = int(input())\nvalues = list(map(int, input().split()))\ntarget = int(input())\nanswer = -1\nfor i in range(n):\n    if values[i] == target:\n        answer = i\n        break\nprint(answer)", [["3\n4 2 4\n4\n", "0\n"], ["2\n1 2\n9\n", "-1\n"], ["0\n\n1\n", "-1\n"]]),
    stdin("Последнее вхождение", "В первой строке N, во второй N чисел, в третьей target. Выведите индекс последнего target или -1.", "n = int(input())\nvalues = list(map(int, input().split()))\ntarget = int(input())\nanswer = -1\nfor i in range(n):\n    if values[i] == target:\n        answer = i\nprint(answer)", [["3\n4 2 4\n4\n", "2\n"], ["1\n1\n2\n", "-1\n"], ["0\n\n0\n", "-1\n"]]),
    stdin("Количество вхождений", "В первой строке N, во второй N чисел, в третьей target. Посчитайте совпадения.", "n = int(input())\nvalues = list(map(int, input().split()))\ntarget = int(input())\ncount = 0\nfor value in values[:n]:\n    if value == target:\n        count += 1\nprint(count)", [["3\n1 1 2\n1\n", "2\n"], ["0\n\n0\n", "0\n"], ["3\n2 2 2\n2\n", "3\n"]])
  ],
  neighbours: [
    stdin("Больше предыдущего", "В первой строке N, во второй N чисел. Посчитайте элементы, которые больше предыдущего.", "n = int(input())\nvalues = list(map(int, input().split()))\ncount = 0\nfor i in range(1, n):\n    if values[i] > values[i - 1]:\n        count += 1\nprint(count)", [["4\n1 3 2 5\n", "2\n"], ["1\n1\n", "0\n"], ["0\n\n", "0\n"]]),
    stdin("Равные соседние пары", "В первой строке N, во второй N чисел. Посчитайте равные соседние пары.", "n = int(input())\nvalues = list(map(int, input().split()))\ncount = 0\nfor i in range(1, n):\n    if values[i] == values[i - 1]:\n        count += 1\nprint(count)", [["4\n1 1 2 2\n", "2\n"], ["1\n5\n", "0\n"], ["0\n\n", "0\n"]]),
    stdin("Локальные максимумы", "В первой строке N, во второй N чисел. Посчитайте элементы, которые больше обоих соседей.", "n = int(input())\nvalues = list(map(int, input().split()))\ncount = 0\nfor i in range(1, n - 1):\n    if values[i] > values[i - 1] and values[i] > values[i + 1]:\n        count += 1\nprint(count)", [["5\n1 4 2 5 3\n", "2\n"], ["2\n1 2\n", "0\n"], ["3\n2 1 2\n", "0\n"]])
  ],
  matrices: [
    stdin("Суммы строк", "В первой строке N и M, затем N строк по M чисел. Выведите суммы строк через пробел.", "n, m = map(int, input().split())\nresult = []\nfor _ in range(n):\n    row = list(map(int, input().split()))\n    total = 0\n    for value in row[:m]:\n        total += value\n    result.append(str(total))\nprint(' '.join(result))", [["2 2\n1 2\n3 4\n", "3 7\n"], ["1 3\n-1 0 1\n", "0\n"], ["2 1\n5\n6\n", "5 6\n"]]),
    stdin("Главная диагональ", "В первой строке N, затем квадратная матрица N на N. Выведите сумму главной диагонали.", "n = int(input())\ntotal = 0\nfor i in range(n):\n    row = list(map(int, input().split()))\n    total += row[i]\nprint(total)", [["2\n1 2\n3 4\n", "5\n"], ["1\n-7\n", "-7\n"], ["3\n1 0 0\n0 2 0\n0 0 3\n", "6\n"]]),
    stdin("Максимум матрицы", "В первой строке N и M, затем N строк по M чисел. Выведите максимальный элемент.", "n, m = map(int, input().split())\nmaximum = None\nfor _ in range(n):\n    row = list(map(int, input().split()))\n    for value in row[:m]:\n        if maximum is None or value > maximum:\n            maximum = value\nprint(maximum)", [["2 2\n1 7\n3 4\n", "7\n"], ["1 1\n-2\n", "-2\n"], ["1 3\n0 0 0\n", "0\n"]])
  ],
  sets: [
    stdin("Число уникальных", "В первой строке N, во второй N чисел. Выведите число различных значений.", "n = int(input())\nvalues = list(map(int, input().split()))\nprint(len(set(values[:n])))", [["3\n1 2 1\n", "2\n"], ["0\n\n", "0\n"], ["4\n7 7 7 7\n", "1\n"]]),
    stdin("Общие значения", "Даны размеры двух наборов и две строки чисел. Выведите количество общих значений.", "n, m = map(int, input().split())\nleft = set(map(int, input().split()))\nright = set(map(int, input().split()))\nprint(len(left & right))", [["3 3\n3 1 2\n2 3 4\n", "2\n"], ["0 1\n\n1\n", "0\n"], ["2 2\n5 5\n5 6\n", "1\n"]]),
    stdin("Только в одном наборе", "Даны размеры двух наборов и две строки чисел. Выведите число значений только из одного набора.", "n, m = map(int, input().split())\nleft = set(map(int, input().split()))\nright = set(map(int, input().split()))\nprint(len(left ^ right))", [["2 2\n1 2\n2 3\n", "2\n"], ["0 0\n\n\n", "0\n"], ["1 1\n5\n5\n", "0\n"]])
  ],
  dicts: [
...
export const lessonProfiles = {
  ...
  "python-loops-nested": profile("вложенные циклы", [
    [earlyProfiles.nested[0], "Пары с суммой", "Переберите все пары индексов с i меньше j и посчитайте нужные пары."],
    [earlyProfiles.nested[1], "Минимум в хвосте", "Для заданной позиции пройдите оставшуюся часть списка и найдите минимум."],
    [earlyProfiles.nested[2], "Тройки с суммой", "Переберите упорядоченные тройки индексов без повторного подсчёта."]
  ]),
  ...
  "python-strings-basics": profile("строки, индексы и длину", [
    [earlyProfiles.strings[0], "Буква в сообщении", "Посчитайте количество букв a в одной введённой строке."],
    [earlyProfiles.strings[1], "Обратная подпись", "Выведите символы строки в обратном порядке."],
    [earlyProfiles.strings[2], "Зеркальное слово", "Сравните строку с её обратной записью и определите палиндром."]
  ]),
  "python-strings-methods-slices": profile("методы строк и срезы", [
    [earlyProfiles.strings[0], "Подсчёт символа методом", "Используйте проход по строке, чтобы узнать число букв a."],
    [earlyProfiles.strings[1], "Разворот срезом", "Получите обратную строку срезом, а не ручной перестановкой."],
    [earlyProfiles.strings[2], "Палиндром срезом", "Проверьте равенство исходной строки и строки, полученной обратным срезом."]
  ]),
  "python-strings-algorithms": profile("проход по символам и состояние", [
    [earlyProfiles.stringAlgorithms[0], "Первая соседняя пара", "Во время прохода найдите индекс первого одинакового соседства."],
    [earlyProfiles.stringAlgorithms[1], "Количество смен", "Посчитайте позиции, где очередной символ отличается от предыдущего."],
    [earlyProfiles.stringAlgorithms[2], "Самая длинная серия", "Храните длину текущей серии и лучший результат при одном проходе."]
  ]),
  "python-strings-runs": profile("серии одинаковых символов", [
    [earlyProfiles.stringAlgorithms[0], "Старт первой серии", "Найдите начало первой серии длиной не меньше двух."],
    [earlyProfiles.stringAlgorithms[1], "Границы серий", "Количество смен символа равно количеству границ между сериями."],
    [earlyProfiles.stringAlgorithms[2], "Длина лучшей серии", "Храните текущую и максимальную длину серии в обычной программе."]
  ]),
  "python-lists-basics": profile("создание списка, индексы и проход", [
    [earlyProfiles.lists[1], "Удвоенный список", "Выведите новый список с удвоенными значениями исходного списка."],
    [earlyProfiles.lists[2], "Позиции чётных", "Соберите индексы элементов, для которых остаток от деления на 2 равен нулю."],
    [earlyProfiles.lists[0], "Положительная сумма", "Пройдите список и сложите только положительные значения."]
  ]),
  "python-lists-mutation": profile("изменение списка по индексу", [
    [earlyProfiles.lists[1], "Новая копия с изменениями", "Выведите список после преобразования каждого элемента."],
    [earlyProfiles.nested[1], "Минимум перед изменением", "Найдите минимум нужной части списка перед последующим изменением."],
    [earlyProfiles.listSearch[2], "Подсчёт до изменения", "Перед заменой элементов проверьте, сколько раз встречается целевое значение."]
  ]),
  "python-lists-processing": profile("фильтрация и преобразование списка", [
    [earlyProfiles.lists[0], "Сумма полезных значений", "Отберите положительные элементы и получите их суммарный вклад."],
    [earlyProfiles.lists[1], "Преобразованный маршрут", "Постройте отдельный список, умножая каждый входной элемент на два."],
    [earlyProfiles.lists[2], "Индексы фильтра", "Сохраните номера элементов, которые проходят проверку чётности."]
  ]),
  "python-lists-linear-search": profile("линейный поиск", [
    [earlyProfiles.listSearch[0], "Первый нужный индекс", "Остановите поиск на первом вхождении цели или выведите -1."],
    [earlyProfiles.listSearch[1], "Последний нужный индекс", "При проходе обновляйте ответ на каждом совпадении."],
    [earlyProfiles.listSearch[2], "Частота цели", "Подсчитайте совпадения с целевым значением за один проход."]
  ]),
  "python-lists-neighbours": profile("соседние элементы", [
    [earlyProfiles.neighbours[0], "Рост после соседа", "Сравните каждый элемент, кроме первого, с предыдущим."],
    [earlyProfiles.neighbours[1], "Равные соседние пары", "Посчитайте границы, на которых два соседних элемента равны."],
    [earlyProfiles.neighbours[2], "Локальные вершины", "Проверьте внутренние элементы по двум соседям."]
  ]),
  "python-lists-2d": profile("двумерные списки", [
    [earlyProfiles.matrices[0], "Сумма каждой строки", "Для каждой строки матрицы вычислите отдельную сумму."],
    [earlyProfiles.matrices[2], "Наибольшее в таблице", "Пройдите все строки и элементы, чтобы найти общий максимум."],
    [earlyProfiles.matrices[1], "Диагональ таблицы", "Используйте одинаковые индексы строки и столбца для главной диагонали."]
  ]),
  "python-lists-matrices": profile("матрицы и координаты", [
    [earlyProfiles.matrices[0], "Итоги строк матрицы", "Выведите результаты, по одному для каждой строки."],
    [earlyProfiles.matrices[1], "Сумма главной диагонали", "Обработайте только клетки, у которых номера строки и столбца совпадают."],
    [earlyProfiles.matrices[2], "Максимальный элемент матрицы", "Найдите максимум прямоугольной таблицы."]
  ]),
  "python-collections-sets": profile("множества и уникальные значения", [
    [earlyProfiles.sets[0], "Сколько разных кодов", "Преобразуйте последовательность в множество и определите количество уникальных значений."],
    [earlyProfiles.sets[1], "Общие участники", "Найдите пересечение двух наборов и определите его размер."],
    [earlyProfiles.sets[2], "Только один список", "Определите количество значений из симметрической разности двух наборов."]
  ]),
  "python-collections-dicts-frequency": profile("словари и таблицы частот", [
    [earlyProfiles.dicts[0], "Частота цели", "Постройте словарь: каждому слову поставьте в соответствие число встреч."],
